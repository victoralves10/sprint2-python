...
"""
                        ...
                        case 2:
                            ...
                            # ===== Pré-visualização: mostra apenas algumas colunas =====
                            preview_colunas = {
                                1: "ID_PACIENTE",
                                2: "NM_COMPLETO",
                                3: "TIPO_CONSULTA",
                            ...
                            numeros_preview = [1, 2, 3, 4]  # colunas que queremos mostrar no preview
                            ...
                            while continuar:
                                ...
                                if id_escolhido == 0:
                                    ...
                                    if not id_encontrado:
                                        ...
                                        continuar = False  # ID encontrado, sai do loop
...
"""
                            ...
                            colunas_exibir = []
                            for i in colunas_exibir_idx:
                                colunas_exibir.append(colunas[i])
...
"""
                        ...
                        case 4:
                            ...
                            # 2️ Solicita o valor do número para pesquisa
                            valor = obter_int(f"\nDigite o número para buscar em {campo_where}: ")

                            # 3️ Escolha do operador
                            operadores = {
                                1: "=",
                                2: ">",
                                3: "<",
                            ...
                            # 4Seleção das colunas para exibição
                            msg_colunas = """ SELECIONE OS CAMPOS QUE DESEJA VER
...
"""
                            ...
                            # Converte índices em nomes de colunas
                            colunas_exibir = [colunas[i] for i in colunas_exibir_idx]
